...
import { faHouse,faPhone,faGear,faRightFromBracket, faSquarePollVertical,faCloudBolt, faRankingStar, faPeopleGroup , faCircleQuestion} from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        ...
        <div className="side-body-wrapper w-1/4 bg-[#25233f] float-left p-[10px] h-full flex flex-col">
             <div className="side-option-panel p-6 flex flex-col ">
                    <a
                        href="/"
                        className={activeLink === "Home" ? activeLinkClassName : linkClassName}
            ...
            <div className="side-option-panel p-6 flex flex-col ">
                <a href="#" className="text-gray-800 mb-4  p-3 bg-blue-500 rounded-md hover:shadow-md hover:text-white"> <FontAwesomeIcon icon={faCircleQuestion} className="mx-2"/>Help</a>
                <a href="#" className="text-gray-800 mb-4  p-3 bg-blue-500 rounded-md hover:shadow-md hover:text-white"> <FontAwesomeIcon icon={faPhone} className="mx-2"/>Contact Us</a>
                <a href="#" className="text-gray-800 mb-4  p-3 bg-blue-500 rounded-md hover:shadow-md hover:text-white"> <FontAwesomeIcon icon={faRightFromBracket} className="mx-2"/>Logout</a>   
            </div>
