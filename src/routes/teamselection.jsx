...
function Teamselection() {
  ...
  const handleSubmit = (event) => {
    ...
    console.log("🚀 ~ file: teamselection.jsx:36 ~ handleSubmit ~ data:", data)
    axios
      .post("http://127.0.0.1:5000/team", {
        venue: venue,
        Temp: temperature,
        Humidity: humidity,
        Wind: wind,
              ...
              <div className="contidion-panel p-5 flex flex-col">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="w-1/3 mx-auto mt-10 text-center">
                    <button
                      type="submit"
                      className="p-3 w-[160px] bg-gradient-to-r from-sky-400 to-blue-500 rounded-full text-white uppercase mx-auto"
                    >
                      Submit{" "}
